...
Suite *test_str_calc() {
  ...
  // tcase_add_test(tc_str_calc, str_calc_test_06);
  tcase_add_test(tc_str_calc, str_calc_test_07);
  tcase_add_test(tc_str_calc, str_calc_test_08);
